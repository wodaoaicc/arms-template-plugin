...
import ${provider.componentPackageName.value}.databinding.Activity${provider.pageName.value}Binding
...
//                .view(this)
    ...
    @Override
    public Activity${provider.pageName.value}Binding getViewBing() {
        return binding;
    }
}
